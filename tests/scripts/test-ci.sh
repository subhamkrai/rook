...
function push() {
    ...
    docker tag "$arm64_Master_Image" quay.io/rook/rook-arm64:latest
    docker push quay.io/rook/rook-arm64:latest
    docker tag "$arm64_Master_Image" ghcr.io/rook/rook-arm64:latest
    docker push ghcr.io/rook/rook-arm64:latest
    ...
    docker tag "$amd64_Master_Image" quay.io/rook/rook-amd64:latest
    docker push quay.io/rook/rook-amd64:latest
    docker tag "$amd64_Master_Image" ghcr.io/rook/rook-amd64:latest
    docker push ghcr.io/rook/rook-amd64:latest
    ...
    ./manifest-tool push from-args --platforms linux/amd64,linux/arm64 --template quay.io/rook/rook-ARCH:latest --target quay.io/rook/rook:latest
    ./manifest-tool push from-args --platforms linux/amd64,linux/arm64 --template ghcr.io/rook/rook-ARCH:latest --target ghcr.io/rook/rook:latest

    ./manifest-tool push from-args --platforms linux/amd64,linux/arm64 --template quay.io/rook/rook-ARCH:$tag_amd64_Release_Image --target quay.io/rook/rook:$tag_amd64_Release_Image
    ./manifest-tool push from-args --platforms linux/amd64,linux/arm64 --template ghcr.io/rook/rook-ARCH:$tag_amd64_Release_Image --target ghcr.io/rook/rook:$tag_amd64_Release_Image
}
