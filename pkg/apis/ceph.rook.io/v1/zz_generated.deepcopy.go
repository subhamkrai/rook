...
func (in *MirroringInfoSpec) DeepCopyInto(out *MirroringInfoSpec) {
	*out = *in
	if in.PoolMirroringInfo != nil {
		in, out := &in.PoolMirroringInfo, &out.PoolMirroringInfo
		*out = new(PoolMirroringInfo)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
func (in *MirroringStatusSpec) DeepCopyInto(out *MirroringStatusSpec) {
	*out = *in
	in.PoolMirroringStatus.DeepCopyInto(&out.PoolMirroringStatus)
	return
}
...
func (in *PoolMirroringStatus) DeepCopyInto(out *PoolMirroringStatus) {
	*out = *in
	if in.Summary != nil {
		...
		*out = new(PoolMirroringStatusSummarySpec)
		**out = **in
	}
	return
}
...
func (in *SSSDSidecar) DeepCopyInto(out *SSSDSidecar) {
	*out = *in
	...
	if in.AdditionalFiles != nil {
		...
		*out = make([]SSSDSidecarAdditionalFile, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SSSDSidecarAdditionalFile) DeepCopyInto(out *SSSDSidecarAdditionalFile) {
	*out = *in
	if in.VolumeSource != nil {
		in, out := &in.VolumeSource, &out.VolumeSource
		*out = new(ConfigFileVolumeSource)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SSSDSidecarAdditionalFile.
func (in *SSSDSidecarAdditionalFile) DeepCopy() *SSSDSidecarAdditionalFile {
	if in == nil {
		return nil
	}
	out := new(SSSDSidecarAdditionalFile)
	in.DeepCopyInto(out)
	return out
}
