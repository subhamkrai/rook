...
func TestShouldRotateCephxKeys(t *testing.T) {
	...
	v20_2_3 := version.CephVersion{Major: 20, Minor: 2, Extra: 3, CommitID: "ababababababa"}
	...
	tests := []test{
		...
		{"policy disabled", v1.CephxConfig{KeyRotationPolicy: "Disabled", KeyGeneration: 5}, v20_2_3, v1.CephxStatus{KeyGeneration: 6, KeyCephVersion: "20.2.0-0"}, false, false},
		{"policy disabled, keyType set", v1.CephxConfig{KeyRotationPolicy: "Disabled", KeyGeneration: 5, KeyType: "aes256k"}, v20_2_3, v1.CephxStatus{KeyGeneration: 6, KeyCephVersion: "20.2.0-0"}, false, false},
		//
		...
		{"policy generation, 5>4", v1.CephxConfig{KeyRotationPolicy: "KeyGeneration", KeyGeneration: 5}, v20_2_0, v1.CephxStatus{KeyGeneration: 4, KeyCephVersion: "20.2.3-0"}, true, false},
		{"policy generation, 4=4", v1.CephxConfig{KeyRotationPolicy: "KeyGeneration", KeyGeneration: 4}, v20_2_3, v1.CephxStatus{KeyGeneration: 4, KeyCephVersion: "20.2.0-0"}, false, false},
		{"policy generation, 5>0", v1.CephxConfig{KeyRotationPolicy: "KeyGeneration", KeyGeneration: 5}, v20_2_0, v1.CephxStatus{KeyGeneration: 0, KeyCephVersion: "20.2.3-0"}, true, false},
		{"policy generation, 0=0", v1.CephxConfig{KeyRotationPolicy: "KeyGeneration", KeyGeneration: 0}, v20_2_3, v1.CephxStatus{KeyGeneration: 0, KeyCephVersion: "20.2.0-0"}, false, false},
		{"policy generation, 1>0, uninit", v1.CephxConfig{KeyRotationPolicy: "KeyGeneration", KeyGeneration: 0}, v20_2_3, v1.CephxStatus{KeyGeneration: 0, KeyCephVersion: "Uninitialized"}, false, false},
		{"policy generation, 2>0, uninit", v1.CephxConfig{KeyRotationPolicy: "KeyGeneration", KeyGeneration: 0}, v20_2_3, v1.CephxStatus{KeyGeneration: 0, KeyCephVersion: "Uninitialized"}, false, false},
		...
		{"policy generation, 5>4, keyType set", v1.CephxConfig{KeyRotationPolicy: "KeyGeneration", KeyGeneration: 5, KeyType: "aes256k"}, v20_2_0, v1.CephxStatus{KeyGeneration: 4, KeyCephVersion: "20.2.3-0"}, true, false},
		{"policy generation, 4=4, keyType set", v1.CephxConfig{KeyRotationPolicy: "KeyGeneration", KeyGeneration: 4, KeyType: "aes256k"}, v20_2_3, v1.CephxStatus{KeyGeneration: 4, KeyCephVersion: "20.2.0-0"}, true, false},
		{"policy generation, 5>0, keyType set", v1.CephxConfig{KeyRotationPolicy: "KeyGeneration", KeyGeneration: 5, KeyType: "aes256k"}, v20_2_0, v1.CephxStatus{KeyGeneration: 0, KeyCephVersion: "20.2.3-0"}, true, false},
		{"policy generation, 0=0, keyType set", v1.CephxConfig{KeyRotationPolicy: "KeyGeneration", KeyGeneration: 0, KeyType: "aes256k"}, v20_2_3, v1.CephxStatus{KeyGeneration: 0, KeyCephVersion: "20.2.0-0"}, true, false},
		{"policy generation, 1>0, keyType set, uninit", v1.CephxConfig{KeyRotationPolicy: "KeyGeneration", KeyGeneration: 0, KeyType: "aes256k"}, v20_2_3, v1.CephxStatus{KeyGeneration: 0, KeyCephVersion: "Uninitialized"}, false, false},
		{"policy generation, 2>0, keyType set, uninit", v1.CephxConfig{KeyRotationPolicy: "KeyGeneration", KeyGeneration: 0, KeyType: "aes256k"}, v20_2_3, v1.CephxStatus{KeyGeneration: 0, KeyCephVersion: "Uninitialized"}, false, false},
		//
		...
		{"policy ceph update, 20.2.3 vs unk", v1.CephxConfig{KeyRotationPolicy: "WithCephVersionUpdate", KeyGeneration: 0}, v20_2_3, v1.CephxStatus{KeyGeneration: 4, KeyCephVersion: ""}, true, false},
		...
		{"policy ceph update, 20.2.3 vs 20.2.0", v1.CephxConfig{KeyRotationPolicy: "WithCephVersionUpdate", KeyGeneration: 0}, v20_2_3, v1.CephxStatus{KeyGeneration: 4, KeyCephVersion: "20.2.0-0"}, true, false},
		{"policy ceph update, 20.2.0 vs 20.2.3", v1.CephxConfig{KeyRotationPolicy: "WithCephVersionUpdate", KeyGeneration: 0}, v20_2_0, v1.CephxStatus{KeyGeneration: 4, KeyCephVersion: "20.2.3-0"}, false, false},
		{"policy ceph update, 20.2.3 vs 20.2.3", v1.CephxConfig{KeyRotationPolicy: "WithCephVersionUpdate", KeyGeneration: 0}, v20_2_3, v1.CephxStatus{KeyGeneration: 4, KeyCephVersion: "20.2.3-0"}, false, false},
		...
		{"policy ceph update, 20.2.3 vs unk, keyType set", v1.CephxConfig{KeyRotationPolicy: "WithCephVersionUpdate", KeyGeneration: 0, KeyType: "aes256k"}, v20_2_3, v1.CephxStatus{KeyGeneration: 4, KeyCephVersion: ""}, true, false},
		...
		{"policy ceph update, 20.2.3 vs 20.2.0, keyType set", v1.CephxConfig{KeyRotationPolicy: "WithCephVersionUpdate", KeyGeneration: 0, KeyType: "aes256k"}, v20_2_3, v1.CephxStatus{KeyGeneration: 4, KeyCephVersion: "20.2.0-0"}, true, false},
		{"policy ceph update, 20.2.0 vs 20.2.3, keyType set", v1.CephxConfig{KeyRotationPolicy: "WithCephVersionUpdate", KeyGeneration: 0, KeyType: "aes256k"}, v20_2_0, v1.CephxStatus{KeyGeneration: 4, KeyCephVersion: "20.2.3-0"}, true, false},
		{"policy ceph update, 20.2.3 vs 20.2.3, keyType set", v1.CephxConfig{KeyRotationPolicy: "WithCephVersionUpdate", KeyGeneration: 0, KeyType: "aes256k"}, v20_2_3, v1.CephxStatus{KeyGeneration: 4, KeyCephVersion: "20.2.3-0"}, true, false},
		//
		{"invalid policy", v1.CephxConfig{KeyRotationPolicy: "InVaLiD", KeyGeneration: 0}, v20_2_3, v1.CephxStatus{KeyGeneration: 4, KeyCephVersion: "20.2.0-0"}, false, true},
	}
	...
	t.Run("can support", func(t *testing.T) {
		for _, tt := range tests {
			...
			t.Run(tt.name, func(t *testing.T) {
				...
				got, err := ShouldRotateCephxKeys(tt.cfg, SupportsKeyTypeVer, tt.imageCephVersion, tt.status, ignoreKeyType)
	...
	t.Run("can support backports", func(t *testing.T) {
		for _, tt := range tests {
			...
			t.Run(tt.name, func(t *testing.T) {
				ignoreKeyType := false // for these tests, don't ignore key type
				got, err := ShouldRotateCephxKeys(tt.cfg, version.CephVersion{Major: 19, Minor: 2, Extra: 6}, tt.imageCephVersion, tt.status, ignoreKeyType)
				if (err != nil) != tt.wantErr {
					t.Errorf("ShouldRotateCephxKeys() error = %v, wantErr %v", err, tt.wantErr)
					return
				}
	...
	t.Run("allow keyType=aes when key-type is unsupported", func(t *testing.T) {
		...
		got, err := ShouldRotateCephxKeys(cfg, v20_2_0, v20_2_0, status, false)
		assert.True(t, got)
		assert.NoError(t, err)
	})
}
...
func Test_parseCephVersionFromStatusVersion(t *testing.T) {
	...
	tests := []struct {
		...
		{"v20.2.3-5", version.CephVersion{}, true},
...
func TestUpdatedCephxStatus(t *testing.T) {
	...
	tests := []struct {
		...
		{"rotate, cephver - status 1 -> 2", true, v1.CephxConfig{KeyRotationPolicy: "WithCephVersionUpdate"}, "", cephVer, v1.CephxStatus{KeyCephVersion: "20.2.3-0", KeyGeneration: 1}, v1.CephxStatus{KeyCephVersion: verStr, KeyGeneration: 2}},
		...
		{"rotate, cephver, with keyType - status 1 -> 2", true, v1.CephxConfig{KeyRotationPolicy: "WithCephVersionUpdate"}, "set", cephVer, v1.CephxStatus{KeyCephVersion: "20.2.3-0", KeyGeneration: 1}, v1.CephxStatus{KeyCephVersion: verStr, KeyGeneration: 2, KeyType: "set"}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestDetermineCephxKeyTypesForEntityType(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, []string{"aes256k", "aes"}, osdTypes)
